...
public enum TetrominoShape {
	...
	J (new Color (3, 0, 235), "J", new int[][] {{0,0},{1,0},{1,1},{1,2}}, new double[] {1.0, 1.0}),
	L (new Color(246, 155, 1), "L", new int[][] {{1,0},{1,1},{1,2},{0,2}}, new double[] {1.0, 0.0}),
	...
	T (new Color(164, 4, 229), "T", new int[][] {{1,0},{1,1},{1,2},{0,1}}, new double[] {0.0, 1.0}),
